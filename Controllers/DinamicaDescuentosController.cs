...
{
    public class DinamicaDescuentosController : BaseController
    {
        public static List<DinamicaDescuentos> lista;
        ...
        {
            List<DinamicaDescuentos> listaDescuentos = new List<DinamicaDescuentos>();
            using (ColgateContext db = new ColgateContext())
            {
                listaDescuentos = (from sc in db.Scoredcard
                                where sc.Formato == "DESCUENTOS"
                                select new DinamicaDescuentos
                                {
                                    Item = sc.Item,
